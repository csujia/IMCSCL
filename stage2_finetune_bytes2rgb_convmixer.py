...
from networks.mobileone import SupCEResNet_mobile,FineTune_mobile,SupConResNet_mobile,LinearClassifier,FineTune3
...
def parse_option():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/work/Jupyter_Notebook/Ve9eD0g/supcon/716/0708_byol2-main/BYOL-2/save/SimCLR/Stage1_convmixer_lr_0.5_bsz_256_size_56_220911-13_09_35/path_models/ckpt_epoch_400.pth', help='path to pre-trained model')
    parser.add_argument('--model', type=str, default='convmixer', choices=['resnet18', 'resnet34', 'resnet50', 'resnet101','convmixer'])
    ...
    # loss two stage
    parser.add_argument('--loss_typea', default="Poly", type=str, help='loss type:CE,Focal,IB,IBFocal')
    parser.add_argument('--loss_typeb', default="IBFocal", type=str, help='loss type')
    # loss分阶段
    parser.add_argument('--start_ib_epoch', default=30, type=int, help='start epoch for IB Loss')
...
def set_loader(opt):
    ...
    if opt.dataset == 'cifar10':
        ...
        train_dataset = MyDataset(opt.data_folder+'/train', transform=train_transform)
...
def main():
    ...
    model = FineTune3(opt.model, model_temp, opt.n_cls)  # the model that need to optimize
    model.to(opt.device)
