...
def parse_option():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/work/Jupyter_Notebook/Ve9eD0g/supcon/716/0708_byol2-main/BYOL-2/save/SimCLR/Stage1_convmixer_lr_0.5_bsz_512_size_56_220828-20_29_22/path_models/ckpt_epoch_1000.pth', help='path to pre-trained model')
    ...
    parser.add_argument('--data_folder', type=str,
                        default='/home/work/datasets/dataset/rgb',
                        help='path to custom dataset')  # 如果数据不是cifar10/100
    parser.add_argument('--mean', type=str, default='(0.63711274, 0.66037816, 0.32009155)',
                        help='mean of dataset in path in form of str tuple')
    parser.add_argument('--std', type=str, default='(0.22281212, 0.28121388, 0.2254635)',
...
def set_loader(opt):
    ...
    if opt.dataset == 'cifar10':
        ...
        train_dataset = MyDataset(opt.data_folder+'/train2', transform=train_transform)
